...
(function () {
    ...
    var NewHearder = /** @class */ (function (_super) {
        __extends(NewHearder, _super);
        function NewHearder(props) {
        ...
        NewHearder.prototype.test = function () {
            console.log(2);
        };
        return NewHearder;
    }(Tool));
    ...
    ReactDOM.render(React.createElement("div", null,
        React.createElement(Tool, { name: "xff" }),
        React.createElement(NewHearder, { name: "abc" })), document.querySelector('#demo'));
})();
